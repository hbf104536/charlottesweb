// Public-domain sample text (opening of Chapter 1) bundled purely so the
// reader can be tried out immediately after installing, with no import step.
// Source: "Alice's Adventures in Wonderland" by Lewis Carroll (1865),
// public domain worldwide. Full text: https://www.gutenberg.org/ebooks/11
export const SAMPLE_TITLE = "Alice's Adventures in Wonderland (sample, ch. 1)";

export const SAMPLE_TEXT = `CHAPTER I. Down the Rabbit-Hole
